    ...
    <div id="wrapper">
        <nav class="navbar navbar-default top-navbar" role="navigation">
            <div class="navbar-header">
                ...
                ?>
<img src="http://prikachi.com/images/548/8488548E.png" width="300px" height="auto" id="img">
            </div>
        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                       <?php
                       echo anchor('doi/show_all_doi', '<i class="glyphicon glyphicon-book"></i> ДОИ Категории');
                       ?>
                   </li>
                   <li>
                    <?php
                ...
                <li>
                    <?php
                    echo anchor('grades/show_teacher_classes', '<i class="glyphicon glyphicon-book"></i> Оценяване');
                    ?>
                </li>
            </ul>
